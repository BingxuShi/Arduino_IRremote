...
#define IR_RECEIVE_PIN      0  // GPIO15 to be compatible with the Arduino Nano RP2040 Connect (pin3)
#define IR_SEND_PIN         15  // GPIO16
#define TONE_PIN            4
#define APPLICATION_PIN     3
#define ALTERNATIVE_IR_FEEDBACK_LED_PIN 1 // E.g. used for examples which use LED_BUILDIN for example output.
#define _IR_TIMING_TEST_PIN 2
